  ...
  {    
    ...
    public static string SetBackgroundUrlForRegistrationLayout(string currentUrlScheme, string url)
    {
      ...
      if (currentUrlScheme != urlSchemeInResourcepath)
      {
        ...
        url = (currentUrlScheme.ToLower() == Enums.UrlScheme.http.ToString() || currentUrlScheme.ToLower() == Enums.UrlScheme.https.ToString()) ? $"{currentUrlScheme}{urlWithUrlSchemeRemoved}" : url;
      }
